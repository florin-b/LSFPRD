...
public enum EnumArticoleDAO {
	...
	GET_ARTICOLE_DISTRIBUTIE("getArticoleDistributie"), GET_PRET("getPret"), GET_STOC_DEPOZIT("getStocDepozit"), GET_ARTICOLE_COMPLEMENTARE(
			...
			"getStocCustodie"), GET_ARTICOLE_CUSTODIE("getListArticoleCustodie"), GET_ARTICOLE_CANT("getArticoleCant"), GET_STOC_MATHAUS(
			"getStocMathaus"), GET_INFOPRET_MATHAUS("getInfoPretMathaus"), GET_CABLURI_05("getCabluri05"), GET_ARTICOLE_ACZC("getArticoleACZC");
